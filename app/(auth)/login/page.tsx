...
export default async function LoginPage() {
  ...
  return (
    <main className="min-h-screen px-4 py-6 text-[#f4e7c2] sm:px-6 lg:px-8">
      <div className="mx-auto grid min-h-[calc(100vh-3rem)] w-full max-w-6xl items-stretch gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <section className="retro-panel overflow-hidden rounded-[28px] p-6 sm:p-8">
          <div className="relative z-10 flex h-full flex-col justify-between gap-10">
            <div className="inline-flex w-fit items-center gap-3 rounded-full border border-[#ffb84d]/25 bg-[#2a1d12] px-4 py-2 text-xs uppercase tracking-[0.32em] text-[#ffcf82]">
              <span className="h-2 w-2 rounded-full bg-[#ff6f61] shadow-[0_0_12px_rgba(255,111,97,0.8)]" />
              FinTrack Terminal
            </div>

            <div className="space-y-6">
              <p className="text-sm uppercase tracking-[0.35em] text-[#ffcf82]">
                Secure sign-in
              </p>
